...
the two that Appendices~\ref{app:strict} and~\ref{app:consistency} point to,
Lemma~\ref{lem:gap} with its strictness and Proposition~\ref{prop:consistency} with the
two counterexamples to its converse, together with the proofs and remarks deferred from
Section~\ref{sec:theory}. Section~S5, the reproducibility specification, including exact
...
disciplines. Section~S8, the extremal constructions whose ideas
Appendix~\ref{app:proofs} states, in full and with the tables of exact values they
attain.}
