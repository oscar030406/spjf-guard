...
counterexamples to its converse. Section~S5, the reproducibility specification,
including exact grids, splits, information clocks and table provenance. Section~S6,
the capacity sweep, physical timed-work experiment, feedback counterexamples and
LPC-EGEE counterfactual. Further theoretical additions follow.}
