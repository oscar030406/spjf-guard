...
physical timed-work experiment, feedback counterexamples, the closed-loop replay with
recorded think times in Table~S18, and the LPC-EGEE counterfactual pooled and, in
Tables~S19 and~S20, per walltime class. Section~S7, additional theory, with Table~S21
comparing the nearest guarantee disciplines and reservation-and-refund charging under
enforced run-time caps. Section~S8, the extremal constructions, each opening
...
% those arguments, and Proposition A1 is Proposition 9 of Supplementary Section S8.5
% (Proposition 6 until the tenth pass added three propositions to Supplementary
% Section S7.6, which precedes it).
