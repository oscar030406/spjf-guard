...
\midrule
CodeBench, busy-hour $\rho \approx \devnum{1.0}$ & \devnum{0.375} & \devnum{0.928} & \devnum{4.56} & yes & \devnum{0.916} & \devnum{98.4}$L$ & \devnum{0.478} / \devnum{3.82}$L$ \\
...
%     Table~\ref{tab:tails}; AUROC from evidence/codebench_service_v2/out_service_v2.txt
