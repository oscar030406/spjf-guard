...
\devnum{0.36\%} of the total $\mathrm{In}$ in any of the nine cells of
Table~\ref{tab:resid}, so the executed-work convention would not change the picture for these
policies. It is not negligible everywhere: under the randomised ranking, which ties many jobs
into one dispatch instant, the share reaches \devnum{14.95\%}. The net-overtake term carries the per-job excess almost entirely:
