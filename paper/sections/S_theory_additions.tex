...
The pointwise-maximal budget $B^{*}=G-L+1$ of the main text's one-server theorem
...
$G \ge L$, which meets the $L$-scale floor of Proposition~3 of the manuscript with
