...
Earlier bounded-overtaking mechanisms count passes
instead~\cite{grosof2021nudge,vanhoudt2022nudgek,grosof2022wcfs}. A count is loose
against a work budget by the ratio $L/\bar{C}$, one to two orders of magnitude on our
traces; Supplementary Sections~S4.4 and~S4.9 give the argument, and
