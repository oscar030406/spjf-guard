...
% Every coordinate below is a cell of Supplementary Table S6 (column "Gap closed",
...
\begin{axis}[gapaxis, ylabel={fraction of gap closed},
  ...
  \addplot[mark=*,thick]            coordinates {(300,0.705) (600,0.740) (1200,0.750)};
...
\begin{axis}[gapaxis, title={$\rho = 0.8$, $k = 5$},
  ...
  \addplot[mark=*,thick]            coordinates {(300,0.738) (600,0.837) (1200,0.850)};
...
\begin{axis}[gapaxis, title={$\rho = 1.0$, $k = 4$},
  ...
  \addplot[mark=*,thick]            coordinates {(300,0.478) (600,0.801) (1200,0.844)};
...
Table~5 of the manuscript; the intervals are in that table and are omitted here.
