...
higher-ranked job; at a dispatch decision, $q$ is eligible if its account reaches its current budget.
The guard dispatches the smallest-ranked eligible job, which need not be $q$. The budget drawn is the age-relative shape, rising at
