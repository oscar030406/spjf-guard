...
%   Field audit: prechecks/codebench_audit/out_tail_and_counts.txt and
%     prechecks/codebench_service_v2/out_service_v2.txt (slopes, kill feedback, the 60 s
%     limit and its last over-limit run, the zero-cost blocks, the two short archives and
%     the release-statistics comparison).
%   Sharpness and circularity: prechecks/firefox_ci_holdout/out_SUMMARY.txt, section E
...
%   Appendix A.2.  Simulated and checked in prechecks/guard_theory; nothing was
