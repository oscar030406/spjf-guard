...
among them (Section~S4). Section numbers here carry an S prefix and every
...
and the extremal constructions and remaining proofs of the manuscript's Appendix~A are
Section~S8. Every empirical figure quoted here is a development
...
behind the degenerate extremal instances of Remark~1 of the manuscript, accounts for at most
...
consistency is proved by induction. The tightness constructions and the
remaining proofs are Section~\ref{sec:supp_constructions} of this file, whose ideas
Appendices~A.2--A.4 and~A.6--A.8 of the manuscript state. We use the manuscript's notation:
...
\subsection{The Two Directions of the Identity}
\label{sec:supp_directions}

This subsection supports the statement in Section~6 of the manuscript that the upward
and downward extremes of Theorem~1 do not have the same content, and that the
executed-work convention would change only the downward one.
...
This subsection supports Remark~2 of the manuscript, that a count bound on overtakes is
...
%   lem:outbound, Corollary~2 cor:necessary, Proposition~3 prop:floor, Remark~2
...
(Remark~2 and equation~(2) of the manuscript). That is the bound a count can give, and it
...
In the executed-work convention of Remark~1 of the manuscript the upward
...
This subsection proves Theorem~6 of the manuscript, which caps how much reordering can buy at a given promise, and Proposition~A1, the exact achievable fraction at one server.
...
%   Appendices A.2, A.3, A.4, A.6, A.7 and A.8 of the manuscript, moved here whole in the
...
%   Corollary~4 cor:k1_frontier, Proposition~3 prop:floor, Proposition~A1 prop:k1frac,
%   Remark~1 rem:directions and (3) eq:guardin.  Simulated and checked in
