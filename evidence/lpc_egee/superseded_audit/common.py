...
DAY = 86400
SPLIT_DAY = 120
OUTAGE = (138, 153)  # includes log-days 138 through 152; fixed by prior hunt
SEED = 3
BOOT_SEED = 20260921
BOOT_N = 2000
...
def protocol():
    return dict(split_log_day=SPLIT_DAY,outage_log_days_half_open=OUTAGE,seed=SEED,bootstrap_seed=BOOT_SEED,bootstrap_replicates=BOOT_N,
                ...
                cap='min(recorded run, per-queue SWF wall limit); theorem uses maximum queue limit 259200 s',
