...
| `stale_charging` | what the guard promises when completion reports arrive late, and which protocol restores Theorem 3 | §6.9 `prop:late`; supplement S4.12 | 0.16 MB |
